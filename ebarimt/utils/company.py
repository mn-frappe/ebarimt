...
def get_merchant_info(settings=None, company: str | None = None, doc=None) -> dict:
    """
...
def get_district_code(settings=None, company: str | None = None, doc=None) -> str | None:
...
def validate_merchant_info(settings=None, company: str | None = None, doc=None) -> dict:
    """
